...
class foo_serviceIfSingletonFactory : virtual public foo_serviceIfFactory {
 public:
  foo_serviceIfSingletonFactory(const boost::shared_ptr<foo_serviceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<foo_serviceIf> iface_;
};
...
class foo_serviceClient : virtual public foo_serviceIf {
 public:
  foo_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  foo_serviceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class foo_serviceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  foo_serviceProcessor(boost::shared_ptr<foo_serviceIf> iface) :
    iface_(iface) {
...
class foo_serviceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  foo_serviceProcessorFactory(const ::boost::shared_ptr< foo_serviceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< foo_serviceIfFactory > handlerFactory_;
};

class foo_serviceMultiface : virtual public foo_serviceIf {
 public:
  foo_serviceMultiface(std::vector<boost::shared_ptr<foo_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~foo_serviceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<foo_serviceIf> > ifaces_;
  foo_serviceMultiface() {}
  void add(boost::shared_ptr<foo_serviceIf> iface) {
...
class foo_serviceConcurrentClient : virtual public foo_serviceIf {
 public:
  foo_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  foo_serviceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
